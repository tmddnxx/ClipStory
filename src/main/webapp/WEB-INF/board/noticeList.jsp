    ...
    <div class="container w-75 mt-5 mx-auto main">
        ...
        <div align="center" class="paging">
            ...
            <%
                if(thisBlock > 1) {
            %>
            <a href="list.board?action=noticeList&pageNum=<%=(firstPage - 1)%>"><span> < 이전 </span></a>
            <%
                }
            %>
            ...
            %>
            <a href="list.board?action=noticeList&pageNum=<%=(lastPage + 1)%>"><span> 다음 ></span> </a>
            <%
                }
            %>
            <a href="<c:url value="list.board?action=noticeList&pageNum=${totalPage}"/>"><span>끝페이지</span></a>
        </div>
