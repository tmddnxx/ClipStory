...
// default photo 삭제 버튼 등록
const removeDefaultBtns = document.querySelectorAll("button[class=removeDefaultPhotoBtn]");
for (let i = 0; i < removeDefaultBtns.length; i++){
    removeDefaultBtns[i].addEventListener("click", function (){
