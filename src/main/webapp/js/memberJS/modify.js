...
const confirmCheck = {id: true, pw: false, pw_re: false, name: true, nick: true};
...
const originalNick = document.getElementById("original-nick");
...
function check_nick(nickName) {
    ...
    if(nickName === originalNick.value){
        warnNick.innerHTML = "";
